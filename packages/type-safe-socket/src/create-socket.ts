...
const buildServerOrClientEvents = <T extends Contract, ENV extends ServerOrClient, Context>(
  ...
  const requestHandler = buildRequestHandlerHandler(
    contract,
    serverOrClient,
    ws,
    requestHandlerHandlers
...
export const createClientSocket = <T extends Contract, Context>(
  contract: T,
  ws: WSLike,
  context?: Context
) => {
...
export const createServerSocket = <T extends Contract, Context>(
  contract: T,
  ws: WSLike,
  context?: Context
) => {
