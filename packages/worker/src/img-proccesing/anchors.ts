import apply_settingJSON from '../../anchors/apply_setting.json'
import apply_settingPNG from '../../anchors/apply_setting.png' with { type: 'file' }
import change_lobby_descriptionJSON from '../../anchors/change_lobby_description.json'
import change_lobby_descriptionPNG from '../../anchors/change_lobby_description.png' with {
  type: 'file',
}
import change_modeJSON from '../../anchors/change_mode.json'
import change_modePNG from '../../anchors/change_mode.png' with { type: 'file' }
import competitive_modeJSON from '../../anchors/competitive_mode.json'
import competitive_modePNG from '../../anchors/competitive_mode.png' with { type: 'file' }
import create_custom_lobbyJSON from '../../anchors/create_custom_lobby.json'
import create_custom_lobbyPNG from '../../anchors/create_custom_lobby.png' with { type: 'file' }
...
import in_game_return_matchJSON from '../../anchors/in_game_return_match.json'
import in_game_return_matchPNG from '../../anchors/in_game_return_match.png' with { type: 'file' }
...
import launch_login_password_continuePNG from '../../anchors/launch_login_password_continue.png' with {
  type: 'file',
}
...
import lobby_pripare_time_settingPNG from '../../anchors/lobby_pripare_time_setting.png' with {
  type: 'file',
}
import lobby_rounds_count_settingJSON from '../../anchors/lobby_rounds_count_setting.json'
import lobby_rounds_count_settingPNG from '../../anchors/lobby_rounds_count_setting.png' with {
  type: 'file',
}
import lobby_settingJSON from '../../anchors/lobby_setting.json'
import lobby_settingPNG from '../../anchors/lobby_setting.png' with { type: 'file' }
import lobby_time_settingJSON from '../../anchors/lobby_time_setting.json'
import lobby_time_settingPNG from '../../anchors/lobby_time_setting.png' with { type: 'file' }
import lock_team_settingJSON from '../../anchors/lock_team_setting.json'
import lock_team_settingPNG from '../../anchors/lock_team_setting.png' with { type: 'file' }
import menu_groupJSON from '../../anchors/menu_group.json'
import menu_groupPNG from '../../anchors/menu_group.png' with { type: 'file' }
...
import share_room_codeJSON from '../../anchors/share_room_code.json'
...
import start_lobbyPNG from '../../anchors/start_lobby.png' with { type: 'file' }
...
import wait_for_payers_move_to_ctPNG from '../../anchors/wait_for_payers_move_to_ct.png' with {
  type: 'file',
}
import wait_for_payers_move_to_tJSON from '../../anchors/wait_for_payers_move_to_t.json'
import wait_for_payers_move_to_tPNG from '../../anchors/wait_for_payers_move_to_t.png' with {
  type: 'file',
}
import wait_for_payers_spectator_kickJSON from '../../anchors/wait_for_payers_spectator_kick.json'
import wait_for_payers_spectator_kickPNG from '../../anchors/wait_for_payers_spectator_kick.png' with {
  type: 'file',
}
import wait_for_payers_spectator_slot_2JSON from '../../anchors/wait_for_payers_spectator_slot_2.json'
import wait_for_payers_spectator_slot_2PNG from '../../anchors/wait_for_payers_spectator_slot_2.png' with {
  type: 'file',
}
import wait_for_payers_spectator_slot_3JSON from '../../anchors/wait_for_payers_spectator_slot_3.json'
import wait_for_payers_spectator_slot_3PNG from '../../anchors/wait_for_payers_spectator_slot_3.png' with {
  type: 'file',
}
import wait_for_payers_spectator_slot_4JSON from '../../anchors/wait_for_payers_spectator_slot_4.json'
import wait_for_payers_spectator_slot_4PNG from '../../anchors/wait_for_payers_spectator_slot_4.png' with {
  type: 'file',
}
import wait_for_payers_spectator_slot_5JSON from '../../anchors/wait_for_payers_spectator_slot_5.json'
import wait_for_payers_spectator_slot_5PNG from '../../anchors/wait_for_payers_spectator_slot_5.png' with {
  type: 'file',
}
import wait_for_payers_spectator_slot_6JSON from '../../anchors/wait_for_payers_spectator_slot_6.json'
import wait_for_payers_spectator_slot_6PNG from '../../anchors/wait_for_payers_spectator_slot_6.png' with {
  type: 'file',
}
...
export const anchors = {
  ...
  launch_login_password_continue: {
    img: launch_login_password_continuePNG,
    offset: launch_login_password_continueJSON,
  },
  ...
  wait_for_payers_move_to_ct: {
    img: wait_for_payers_move_to_ctPNG,
    offset: wait_for_payers_move_to_ctJSON,
  },
  free_slot_4: { img: free_slot_4PNG, offset: free_slot_4JSON },
  in_game_return_match: { img: in_game_return_matchPNG, offset: in_game_return_matchJSON },
  free_slot_5: { img: free_slot_5PNG, offset: free_slot_5JSON },
  wait_for_payers_spectator_slot_6: {
    img: wait_for_payers_spectator_slot_6PNG,
    offset: wait_for_payers_spectator_slot_6JSON,
  },
  apply_setting: { img: apply_settingPNG, offset: apply_settingJSON },
  lobby_rounds_count_setting: {
    img: lobby_rounds_count_settingPNG,
    offset: lobby_rounds_count_settingJSON,
  },
  wait_for_payers_spectator_kick: {
    img: wait_for_payers_spectator_kickPNG,
    offset: wait_for_payers_spectator_kickJSON,
  },
  ...
  change_mode: { img: change_modePNG, offset: change_modeJSON },
  free_slot_10: { img: free_slot_10PNG, offset: free_slot_10JSON },
  lobby_time_setting: { img: lobby_time_settingPNG, offset: lobby_time_settingJSON },
  ...
  wait_for_payers_spectator_slot_5: {
    img: wait_for_payers_spectator_slot_5PNG,
    offset: wait_for_payers_spectator_slot_5JSON,
  },
  ...
  wait_for_payers_spectator_slot_4: {
    img: wait_for_payers_spectator_slot_4PNG,
    offset: wait_for_payers_spectator_slot_4JSON,
  },
  ...
  change_lobby_description: {
    img: change_lobby_descriptionPNG,
    offset: change_lobby_descriptionJSON,
  },
  wait_for_payers_move_to_t: {
    img: wait_for_payers_move_to_tPNG,
    offset: wait_for_payers_move_to_tJSON,
  },
  ...
  lobby_pripare_time_setting: {
    img: lobby_pripare_time_settingPNG,
    offset: lobby_pripare_time_settingJSON,
  },
  ...
  wait_for_payers_spectator_slot_3: {
    img: wait_for_payers_spectator_slot_3PNG,
    offset: wait_for_payers_spectator_slot_3JSON,
  },
  ...
  wait_for_payers_spectator_slot_2: {
    img: wait_for_payers_spectator_slot_2PNG,
    offset: wait_for_payers_spectator_slot_2JSON,
  },
