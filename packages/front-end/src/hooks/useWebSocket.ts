import { type Runner, wsContract } from '@ovenstandoff/contract'
...
export function useWebSocket({ serverKey, onConnectionChange }: UseWebSocketOptions) {
