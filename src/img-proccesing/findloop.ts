...
export async function findLoop(anchorKey: keyof typeof anchors, stateManager: StateManager, options?: {times?: number, wait?: number}): Promise<{sucess: true, error: false} | {sucess: false, error: true}> {
